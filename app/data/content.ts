...
export const ui: Record<Language, UiCopy> = {
  en: {
    ...
    heroBody:
      "Follow data from observation to deployment. See where leakage begins, why metrics disagree, and how reliable systems are assembled.",
    start: "Start with lesson 01",
    ...
    lessonEyebrow: "03 · Pilot reader",
    lessonTitle: "Six foundations, written from scratch.",
    lessonBody:
      "Each lesson has an exact Korean, English, and Vietnamese counterpart and is clearly marked as a preview until human review is complete.",
    read: "Read lesson",
    minutes: "min",
  ...
  vi: {
    ...
    heroBody:
      "Theo dòng dữ liệu từ quan sát đến triển khai. Nhận ra nơi rò rỉ dữ liệu bắt đầu, vì sao các chỉ số bất đồng và cách tạo nên một hệ thống đáng tin cậy.",
    start: "Bắt đầu từ bài 01",
    ...
    lessonEyebrow: "03 · Trình đọc thử nghiệm",
    lessonTitle: "Sáu nền tảng, được viết mới hoàn toàn.",
    lessonBody:
      "Mỗi bài có phiên bản Hàn, Anh và Việt tương ứng chính xác, đồng thời được ghi rõ là bản xem trước cho đến khi hoàn tất phản biện.",
    read: "Đọc bài",
    minutes: "phút",
  ...
  ko: {
    ...
    heroBody:
      "관측에서 배포까지 데이터의 흐름을 따라갑니다. 누수가 어디서 시작되고, 지표가 왜 엇갈리며, 신뢰할 수 있는 시스템이 어떻게 조립되는지 확인하세요.",
    start: "레슨 01부터 시작",
    explore: "학습 지도 보기",
    ...
    lessonEyebrow: "03 · 파일럿 리더",
    lessonTitle: "처음부터 새로 쓴 여섯 가지 기초.",
    lessonBody:
      "모든 레슨은 한국어·영어·베트남어로 정확히 연결되며, 사람의 검토가 끝날 때까지 프리뷰 상태를 명확히 표시합니다.",
    read: "레슨 읽기",
    minutes: "분",
